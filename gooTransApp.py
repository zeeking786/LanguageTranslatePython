...
languages = ["Tamil","Telugu","Spanish",  "Russian", "Punjabi", "Marathi", "Latin", "Korean", "Kannada", "Japanese",
             "Hindi", "Gujarati", "German", "English", "French", "Chinese", "Arabic"]
